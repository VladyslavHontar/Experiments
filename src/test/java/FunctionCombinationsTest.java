...
public class FunctionCombinationsTest {
  ...
  void name() {
    ...
    Function<Person, Integer> getCountVowelsSurname = personStringPropertyToLength(Person::getSurname, FunctionCombinationsTest::getCountVowelsJava8);
    assertThat(getCountVowelsSurname.apply(ivan)).isEqualTo(3);

    Function<Person, Integer> getCountVowelsName = personStringPropertyToLength(Person::getName, FunctionCombinationsTest::getCountVowelsJava8);
    assertThat(getCountVowelsName.apply(ivan)).isEqualTo(2);

    Function<Person, String> extractor = Person::getSurname;
    Function<Person, Integer> getVowels = extractor.andThen(FunctionCombinationsTest::getCountVowelsJava8);
